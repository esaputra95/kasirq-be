...
import * as CategoryService from "#root/stores/services/masters/CategoryService";

const getData = async (
    req: Request<{}, {}, {}, CategoryQueryInterface>,
    res: Response,
) => {
    try {
...
const getSelect = async (req: Request<{ slug: string }>, res: Response) => {
    try {
