...
export const getCategories = async (
    ...
    return {
        ...
        data: { category: data, info: { page, limit: take, total } },
    };
};
...
export const getCategoriesForSelect = async (
    ...
    // Find store by slug to get the correct ownerId (multi-tenant support)
    ...
    const data = await Model.categories.findMany({ where: filter, take: 25 });
