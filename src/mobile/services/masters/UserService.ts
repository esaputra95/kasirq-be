 ...
 */
export const getUsers = async (query: UserQueryInterface, userId?: string, userType?: string) => {
    // PAGING
 ...
 * Create new user
 */
export const createUser = async (userData: any, userId: string, userType: string) => {
...
export const changePassword = async (userId: string, currentPassword: string, newPassword: string) => {
    ...
    if (!isPasswordValid) {
        throw new ValidationError("Current password is incorrect", 401, "currentPassword");
    }
